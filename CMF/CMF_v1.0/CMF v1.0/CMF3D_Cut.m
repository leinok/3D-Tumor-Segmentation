function [u, erriter, i, timet] = CMF3D_Cut(x);
%
...
alpha = 0.1*ones(rows,cols,heights); 
cc = 0.15;
errbound = 5e-5;
numIter = 2000;
steps = 0.11;
...
% fHandle2 = figure('Name', 'Original', 'NumberTitle', 'Off'), isosurface(x, 80), axis([0 cols 0 rows 0 heights]);
% h2 = rotate3d(fHandle2);
% set(h2, 'Enable', 'on');
